            ...
            if (options.container != "") {
                ...
                if (options.display_gallery) {
                    if (typeof data.is_private !== "undefined" && data.is_private === true) {
                        ...
                        for (var i = 0; i < max; i++) {
                            ...
                            html += "<a data-fancybox='gallery' href='" + image + "' class='instagram-" + type_resource + "' rel='noopener'>";
                ...
                if (options.display_igtv && typeof data.edge_felix_video_timeline !== "undefined") {
                    ...
                    if (igtv.length > 0) {
                        ...
                        for (var i = 0; i < max; i++) {
                            html += "<a data-fancybox='gallery'  href='https://www.instagram.com/p/" + igtv[i].node.shortcode + "' rel='noopener'>";
