...
function checa_seguranca(pass, campo){
		...
		if(entrada == 0){
				resultado = 'A Seguran�a de sua senha �: <font color=\'#388000\'><strong>EXCELENTE</strong></font>';
		} else if(entrada == -1){
				resultado = 'A Seguran�a de sua senha �: <font color=\'#0037FF\'><strong>M�DIA</strong></font>';
		} else if(entrada == -2){
				resultado = 'A Seguran�a de sua senha �: <font color=\'#FFB200\'><strong>BAIXA</strong></font>';
		} else if(entrada == -3){
				resultado = 'A Seguran�a de sua senha �: <font color=\'#FF0000\'><strong>MUITO BAIXA</strong></font>';
		}
...
function formatar(src, mask, evtKeyPress)
{
  ...
  if (tecla != 8) //s� for�a a escrita da m�scara de a tecla pressionada N�O for o BACKSPACE
  {
